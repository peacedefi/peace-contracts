...
// Masterchef is the leader of the coalition. He can make Peace and he is a fair guy.
//
...
contract Masterchef is Ownable {
    ...
    // Update the given pool's PEACE allocation point and deposit fee. Can only be called by the owner.
    ...
    function updatePool(uint256 _pid) public {
        ...
        peace.mint(address(this), peaceReward);
    ...
    //PEACE has to add hidden dummy pools inorder to alter the emission, here we make it simple and transparent to all.
    function updateEmissionRate(uint256 _peacePerBlock) public onlyOwner {
        massUpdatePools();
        peacePerBlock = _peacePerBlock;
    }
}